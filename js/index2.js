...
$('.selfActive').click(function () {
    $('.selfActive').css("background-image","url(./img/absence/資產4.svg)")
    $('.other').css("background-image","url(./img/absence/資產5.svg)")
})
//
$('.other').click(function () {
    $('.selfActive').css("background-image","url(./img/absence/資產2.svg)")
    $('.other').css("background-image","url(./img/absence/資產3.svg)")
})
