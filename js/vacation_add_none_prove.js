    ...
    post_btn.onclick = function () {
        ...
        l_step_img.setAttribute("src", "./img/vacation/schedule-none-prove-step-" + n + ".svg")
    }
    ...
    cancel_btn.onclick = function () {
        ...
        cancel_btn.setAttribute("href", "#leave-step-" + p)
        l_step_img.setAttribute("src", "./img/vacation/schedule-none-prove-step-" + p + ".svg")
        post_btn.setAttribute("href", "#leave-step-" + n)
        if (p >= 1) {
            cancel_btn.classList.remove("active")
            p--
    ...
    $('.post-btn').click(function () {
        ...
        //控制第四頁顯示送出鈕
        if ($('.leave-step-img').attr('src').split("-").pop() == "3.svg") {
